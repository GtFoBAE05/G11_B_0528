package com.example.gd8_b_0528
...
import com.example.gd8_b_0528.api.MahasiswaApi
import com.example.gd8_b_0528.models.Mahasiswa
...
class AddEditActivity : AppCompatActivity() {
    ...
    companion object{
        ...
        private val PRODI_LIST= arrayOf("Informatika", "Arsitektur", "Biologi", "Manajemen", "Ilmu komunikasi", "Ilmu hukum")
    }
    ...
    private fun getMahasiswaById(id: Long){
        ...
        val stringRequest: StringRequest=
            object : StringRequest(Method.GET, MahasiswaApi.GET_BY_ID_URL+id, Response.Listener { response ->
                val gson= Gson()
